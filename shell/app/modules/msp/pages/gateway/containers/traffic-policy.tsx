...
import { Button, Input, Select, InputNumber } from 'core/nusi';
  ...
  render() {
    ...
    const fieldsList = [
      {
        ...
        name: 'policyName',
        rules: [{ pattern: /^[a-zA-z0-9_-]+$/, message: i18n.t('msp:display name') }],
        itemProps: {
          placeholder: i18n.t('can only contain letters, numbers, underscores and hyphens'),
        },
      },
      {
        label: i18n.t('msp:policy name'),
        name: 'displayName',
        required: false,
        itemProps: {
          placeholder: i18n.t('msp:as policy name by default'),
        },
      },
      {
        label: i18n.t('msp:request limit'),
        name: 'config',
    ...
    return (
      <div>
        ...
        <FormModal
          width="600px"
          name={i18n.t('msp:flow control strategy')}
