...
import { Button, Select, Input, Table, Tooltip } from 'core/nusi';
...
export const ApiImport = ({ updateImportParams, importApiParams }: IProps) => {
  ...
  const rowSelection = {
    ...
    selections: [
      {
        key: 'all-data',
        text: i18n.t('msp:select all apis'),
        onSelect: () => {
      ...
      {
        key: 'invert-all-data',
        text: i18n.t('msp:inverse selection of all apis'),
        onSelect: () => {
  ...
  return (
    <div className="api-import">
      <div className="mb-4 api-filter flex items-center justify-between">
        <div>
          <AppServiceFilter
      ...
      <div className="mb-4 inline-flex items-center">
        <span>{i18n.t('msp:service routing prefix')}:</span>
