...
import { Input, Button, InputNumber, Collapse, Switch } from 'core/nusi';
      ...
      <Collapse defaultActiveKey={['proxy', 'cors', 'custom']}>
        <Panel
          header={
            <div className="flex items-center justify-between">
              <span>{i18n.t('msp:traffic receive forwarding')}</span>
              <div className="switch-contaienr flex items-center justify-between">
        ...
        >
          <div className="gateway-policy-item">
            <span className="policy-label">{i18n.t('msp:force jump to HTTPS')}</span>
          ...
          <div className="gateway-policy-item">
            <span className="policy-label">{i18n.t('msp:entry domain name passthrough')}</span>
            <div className="policy-content">
              <Switch
                disabled={enableGlobalBusinessProxy || !businessProxyEnable}
                checkedChildren={<CustomIcon type="check" />}
          ...
          <div className="gateway-policy-item">
            <span className="policy-label">{i18n.t('msp:open request buffer')}</span>
            <div className="policy-content">
              <Switch
                disabled={enableGlobalBusinessProxy || !businessProxyEnable}
                checkedChildren={<CustomIcon type="check" />}
          ...
          <div className="gateway-policy-item">
            <span className="policy-label">{i18n.t('msp:open response buffer')}</span>
            <div className="policy-content">
              <Switch
                disabled={enableGlobalBusinessProxy || !businessProxyEnable}
                checkedChildren={<CustomIcon type="check" />}
          ...
          <div className="gateway-policy-item">
            <span className="policy-label">{i18n.t('msp:client request restrictions')}</span>
            <div className="policy-content">
              <InputGroup compact>
                <InputNumber
                  disabled={enableGlobalBusinessProxy || !businessProxyEnable}
          ...
          <div className="gateway-policy-item">
            <span className="policy-label">{i18n.t('msp:client request timed out')}</span>
            <div className="policy-content">
              <InputGroup compact>
                <InputNumber
                  disabled={enableGlobalBusinessProxy || !businessProxyEnable}
          ...
          <div className="gateway-policy-item">
            <span className="policy-label">{i18n.t('msp:client response timed out')}</span>
            <div className="policy-content">
              <InputGroup compact>
                <InputNumber
                  disabled={enableGlobalBusinessProxy || !businessProxyEnable}
          ...
          {/* <div className="gateway-policy-item">
            <span className="policy-label">{i18n.t('msp:backend build timeout')}</span>
            <div className="policy-content">
              <InputGroup compact>
                <InputNumber
                  min={0}
          ...
          <div className="gateway-policy-item">
            <span className="policy-label">{i18n.t('msp:backend request timeout')}</span>
            <div className="policy-content">
              <InputGroup compact>
                <InputNumber
                  disabled={enableGlobalBusinessProxy || !businessProxyEnable}
          ...
          <div className="gateway-policy-item">
            <span className="policy-label">{i18n.t('msp:backend response timeout')}</span>
            <div className="policy-content">
              <InputGroup compact>
                <InputNumber
                  disabled={enableGlobalBusinessProxy || !businessProxyEnable}
        ...
        <Panel
          header={
            <div className="flex items-center justify-between">
              <span>{i18n.t('msp:cross-domain access')}</span>
              <div className="switch-contaienr flex items-center justify-between">
                <span onClick={(e) => e.stopPropagation()} className=" mr-5">
                  {i18n.t('msp:enable rule')}&nbsp;
                  <Switch
        ...
        >
          <div className="gateway-policy-item">
            <span className="policy-label">HTTP {i18n.t('msp:method')}</span>
            <div className="policy-content">
              <Input
          ...
          <div className="gateway-policy-item">
            <span className="policy-label">HTTP {i18n.t('msp:request header')}</span>
            <div className="policy-content">
              <div className="policy-content">
                <TextArea
                  className="policy-input"
          ...
          <div className="gateway-policy-item">
            <span className="policy-label">{i18n.t('msp:cross-domain address')}</span>
            <div className="policy-content">
              <Input
                className="policy-input"
                disabled={enableGlobalBusinessCors || !businessCorsEnable}
          ...
          <div className="gateway-policy-item">
            <span className="policy-label">{i18n.t('msp:carry')} cookie</span>
            <div className="policy-content">
              <Switch
                disabled={enableGlobalBusinessCors || !businessCorsEnable}
                checkedChildren={<CustomIcon type="check" />}
          ...
          <div className="gateway-policy-item">
            <span className="policy-label">{i18n.t('msp:cache time')}</span>
            <div className="policy-content">
              <InputGroup compact>
                <InputNumber
                  disabled={enableGlobalBusinessCors || !businessCorsEnable}
        ...
        <Panel
          header={
            <div className="flex items-center justify-between">
              <span>{i18n.t('msp:custom nginx configuration')}</span>
              <div className="switch-contaienr flex items-center justify-between">
                <span onClick={(e) => e.stopPropagation()} className=" mr-5">
                  {i18n.t('msp:enable rule')}&nbsp;
                  <Switch
        ...
        >
          <div className="gateway-policy-item">
            <span className="policy-label">nginx {i18n.t('msp:configuration')}</span>
            <div className="policy-content">
              <TextArea
                className="policy-input"
                value={config}
                ...
                rows={4}
                placeholder={i18n.t('msp:location block configuration')}
