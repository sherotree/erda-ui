...
import { Input, Table, Dropdown, Tooltip, Button, Modal } from 'core/nusi';
...
const AppSelector = (props: IAppSelectorProps) => {
  ...
  return (
    ...
    >
      <div className="app-name flex items-center justify-between">
        <span className={nameStyle}>{chosenApp || i18n.t('msp:select application')}</span>
...
const ConfigCenter = () => {
  ...
  const msMenuMap = mspStore.useStore((s) => s.msMenuMap);
  ...
  return (
    <div className="micro-config-center">
      ...
      <div className="config-content">
        ...
        <Table dataSource={configListMap[chosenApp] || []} columns={columns} scroll={{ x: '100%' }} />
      </div>
